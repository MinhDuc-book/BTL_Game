...
set_target_properties(OpenEXR::Iex PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libIex-3_3.dll"
  )

list(APPEND _cmake_import_check_targets OpenEXR::Iex )
list(APPEND _cmake_import_check_files_for_OpenEXR::Iex "${_IMPORT_PREFIX}/lib/libIex.dll.a" "${_IMPORT_PREFIX}/bin/libIex-3_3.dll" )
...
set_target_properties(OpenEXR::IlmThread PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libIlmThread-3_3.dll"
  )

list(APPEND _cmake_import_check_targets OpenEXR::IlmThread )
list(APPEND _cmake_import_check_files_for_OpenEXR::IlmThread "${_IMPORT_PREFIX}/lib/libIlmThread.dll.a" "${_IMPORT_PREFIX}/bin/libIlmThread-3_3.dll" )
...
set_target_properties(OpenEXR::OpenEXRCore PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libOpenEXRCore-3_3.dll"
  )

list(APPEND _cmake_import_check_targets OpenEXR::OpenEXRCore )
list(APPEND _cmake_import_check_files_for_OpenEXR::OpenEXRCore "${_IMPORT_PREFIX}/lib/libOpenEXRCore.dll.a" "${_IMPORT_PREFIX}/bin/libOpenEXRCore-3_3.dll" )
...
set_target_properties(OpenEXR::OpenEXR PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libOpenEXR-3_3.dll"
  )

list(APPEND _cmake_import_check_targets OpenEXR::OpenEXR )
list(APPEND _cmake_import_check_files_for_OpenEXR::OpenEXR "${_IMPORT_PREFIX}/lib/libOpenEXR.dll.a" "${_IMPORT_PREFIX}/bin/libOpenEXR-3_3.dll" )
...
set_target_properties(OpenEXR::OpenEXRUtil PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libOpenEXRUtil-3_3.dll"
  )

list(APPEND _cmake_import_check_targets OpenEXR::OpenEXRUtil )
list(APPEND _cmake_import_check_files_for_OpenEXR::OpenEXRUtil "${_IMPORT_PREFIX}/lib/libOpenEXRUtil.dll.a" "${_IMPORT_PREFIX}/bin/libOpenEXRUtil-3_3.dll" )
